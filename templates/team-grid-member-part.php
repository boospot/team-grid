...
?>
<div class="team-grid__box single__team-grid__box team-grid__box__in-active">
...
<!--            <i class="fas fa-times" aria-hidden="true"></i>-->
            <svg xmlns="http://www.w3.org/2000/svg" width="24" data-name="Layer 1" viewBox="0 0 64 64"><line x1="9.37" x2="54.63" y1="9.37" y2="54.63" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-width="4"/><line x1="9.37" x2="54.63" y1="54.63" y2="9.37" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-width="4"/></svg>
        </div>
        <h3><?php the_title() ?></h3>
